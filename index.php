		...
		<head><meta charset="utf-8"/>
			...
			<body>
				...
				<h2>Data Design Analysis</h2>
					<p>For my data design project I will evaluate the usage scenarios for both a specific article and for a category. The steps listed in the use scenario are for the personas, however if you hover your mouse cursor over the steps, you will see the steps the website is taking.</p>
